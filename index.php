    ...
    <div class="container">
      <div class="mt-5 mb-5 px-5">
        <header class="pb-3 mb-3">
          <a
            href="https://inixindo.id"
            class="d-flex align-items-center text-dark text-decoration-none"
          >
            <img
              src="https://i.ibb.co/4W5dH5L/Logo-X-Transparent.png"
              alt="Logo-X"
              width="32"
              height="32"
            />
                      ...
                      <div class="card-body text-secondary">
                        <form action="" method="post">
                          <div class="form-group mb-3">
                            <label for="username" class="text-dark form-label"
                              >Username</label
                            >
                            <input
                              type="text"
                            ...
                            <small
                              ...
                              >**Username is missing</small
                            >
                          </div>
                          <div class="form-group mb-3">
                            <label for="email" class="text-dark form-label"
                              >Email</label
                            >
                            <input
                              type="email"
        ...
        <hr />
        <footer
          class="d-flex flex-wrap justify-content-between align-items-center py-3 my-3"
        >
